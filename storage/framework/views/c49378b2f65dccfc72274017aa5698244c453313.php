        ...
        <header class="topbar" data-navbarbg="skin6">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <!-- Logo -->
                    <!-- ============================================================== -->
                    <a class="d-flex navbar-brand justify-content-center" href="<?php echo e(route('dashboard')); ?>">
                        <img src="<?php echo e(asset('favicon/pngegg.png')); ?>" alt="homepage" class="dark-logo" width="60" />
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
                    <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav float-end">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic"
                                ...
                                aria-expanded="false">
                                <img src="<?php echo e(asset(Auth::user()->image)); ?>" alt="avatar user" class="m-2"
                                    width="31"><?php echo e(Auth::user()->name); ?>

                            </a>
                            <ul class="dropdown-menu dropdown-menu-end user-dd animated"
                                aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="<?php echo e(route('change-infomation')); ?>"><i
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="<?php echo e(route('user.index')); ?>" aria-expanded="false"><i
                                    class="mdi mdi-account-multiple-outline"></i><span class="hide-menu">User
                                    Management</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="<?php echo e(route('role.index')); ?>" aria-expanded="false"><i
                                    class="mdi mdi-face"></i><span class="hide-menu">Role Management</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="<?php echo e(route('slide_banner.index')); ?>" aria-expanded="false"><i
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="<?php echo e(route('exam.index')); ?>" aria-expanded="false"><i
...
<?php /**PATH /var/www/html/resources/views/layouts/admin/master-admin.blade.php ENDPATH**/ ?>