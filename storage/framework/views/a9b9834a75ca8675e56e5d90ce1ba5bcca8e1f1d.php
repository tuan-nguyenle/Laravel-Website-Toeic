<?php $__env->startSection('change-information'); ?>
    <form method="POST" action="<?php echo e(route('update-password')); ?>" id="passwordForm">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.edit-profile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/changePassword.blade.php ENDPATH**/ ?>